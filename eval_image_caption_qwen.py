...
def evaluate_captions():
    ...
    # Update the file path to your CSV file containing: Context, Source, Subclause, Image Path, Image Caption
    dataset_path = "/DATAY/telecom/ImageRetrieval/benchmark_image_caption.csv"
    df = pd.read_csv(dataset_path) # Remove .head(10) to process the full dataset
